...
const About = () => {
  return (
    <div className="flex flex-col gap-2 text-gray-400 r-6 px-3 py-4 backdrop-blur-lg bg-black bg-opacity-30 w-3/4 lg:w-1/2 shadow-md shadow-black/50 mx-auto">
